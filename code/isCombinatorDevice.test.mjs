...
import isCombinatorDevice from "./isCombinatorDevice";

test("When given parameters from a combinator device, it should return true", () =>
  expect(
    isCombinatorDevice([
...
test("When given parameters that are not from a combinator device, it should return false", () =>
  expect(
    isCombinatorDevice([
      { name: "Singen", value: 0.23 },
      { name: "Tanzen", value: 0.88 },
